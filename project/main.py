...
local_server=True
app=Flask(__name__)
app.secret_key="vishruthms"

login_manager=LoginManager(app)
login_manager.login_view='login'

app.config['SQLALCHEMY_DATABASE_URI']='mysql://root:@localhost/covid_19_dbms'
db=SQLAlchemy(app)
...
def test():
    try:
        a=Test.query.all()
        print(a)
        return f'VISHRUTH ! YOUR DATABASE IS CONNECTED'
    except Exception as e:
        print(e)
        return f'VARUN ! YOUR DATABASE IS NOT CONNECTED {e}'
